...
If you feel your architecture warrants additional Elastic IP addresses, you can request a limit increase\. To request an increase, complete the [Amazon VPC](https://console.aws.amazon.com/support/home#/case/create?issueType=service-limit-increase&limitType=service-code-vpc) limit request form \(choose **VPC Elastic IP Address Limit**\)\. Describe your use case so that we can understand your needs\. To request Elastic IP addresses for EC2\-Classic, complete the [Amazon EC2 Elastic IP Address](https://console.aws.amazon.com/support/home#/case/create?issueType=service-limit-increase&limitType=service-code-elastic-ips) limit request form\.