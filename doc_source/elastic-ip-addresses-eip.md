...
+ Open the Amazon EC2 console at [https://console\.aws\.amazon\.com/ec2/](https://console.aws.amazon.com/ec2/), chose **Limits** from the navigation pane and type **IP** in the search field\.
