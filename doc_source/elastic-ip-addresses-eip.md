...
+ An Elastic IP address (from Amazon's pool of IPv4 addresses) is for use in a specific region only and it can not be moved to a different region from where it was originally allocated.
