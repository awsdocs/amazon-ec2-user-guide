...
1. [Launch Spot Instances as the default purchasing option](#ec2-fleet-config1)

1. [Launch On\-Demand Instances as the default purchasing option](#ec2-fleet-config2)
