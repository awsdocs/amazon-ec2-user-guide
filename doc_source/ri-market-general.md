...
+ In order to list a regional Reserved Instance in the marketplace, you must modify the scope to zonal as it is not possible to sell regional Reserved Instances via the console\.
