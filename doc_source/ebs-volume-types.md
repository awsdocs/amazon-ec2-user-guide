...
| Use cases | <!-- GP2 & GP3 SSDs are not just for "development and test environments". These types of SSDs can also be used in non-critical production workloads which don't require high IOPS performance. If you add the line "development and test environments" then people might wrongly think that GP2 or GP3 cannot be used in production environment, which is quite wrong. --> [\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-volume-types.html)  |  Workloads that require: [\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-volume-types.html)  |  [\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-volume-types.html)  | 
