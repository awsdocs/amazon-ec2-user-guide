...
**FreeBSD AMIs**  
With FreeBSD 12\.2\-RELEASE or later, you can run the ebsnvme\-id command as above, passing either the name of the NVMe device \(for example, `nvme0`\) or the disk device \(for example, `nvd0` or `nda0`\).
