...
|  | 
| --- |
| The Kernel Live Patching feature for Amazon Linux 2 is in preview release and is subject to change\. | 
...
Amazon Linux 2 kernel live patches are made available as signed RPM packages in the existing Amazon Linux 2 repositories\. The patches can be installed using existing **yum** workflows\.
