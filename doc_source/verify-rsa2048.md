...
1. Add the AWS RSA\-2048 public certificate for your Region to a new file named `certificate`\. Use one of the following commands depending on the Region of your instance\.
