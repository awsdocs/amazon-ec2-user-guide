...
**Topics**
+ [your AMI](#selling-your-ami)
+ [a paid AMI](#using-paid-amis-finding-paid-ami)
+ [a paid AMI](#using-paid-amis-purchasing-paid-ami)
+ [the product code for your instance](#get-product-code)
+ [paid support](#using-paid-amis-support)
+ [Bills for paid and supported AMIs](#using-paid-amis-bills)
+ [your AWS Marketplace subscriptions](#marketplace-manage-subscriptions)

## your AMI<a name="selling-your-ami"></a>
...
## a paid AMI<a name="using-paid-amis-finding-paid-ami"></a>
...
### a paid AMI using AWS Marketplace<a name="finding-an-ami-mkt"></a>
...
### a paid AMI using the AWS CLI<a name="finding-paid-windows-ami-cli"></a>
...
## a paid AMI<a name="using-paid-amis-purchasing-paid-ami"></a>
...
### a paid AMI using the console<a name="purchase-paid-ami-console"></a>
...
### to a product using AWS Marketplace<a name="subscribe-to-paid-ami"></a>
...
## the product code for your instance<a name="get-product-code"></a>
...
## paid support<a name="using-paid-amis-support"></a>
...
## your AWS Marketplace subscriptions<a name="marketplace-manage-subscriptions"></a>
