...
Amazon EC2 implements the following service\-specific condition keys\. For information about which condition keys you can use with which Amazon EC2 resources, on an action\-by\-action basis, [Actions, Resources, and Condition Keys for Amazon EC2](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_amazonec2.html) in the *IAM User Guide*\.
