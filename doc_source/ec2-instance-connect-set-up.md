...
+ EC2 with Amazon Linux 2 has wrong permission in root folder, execution of AuthorizedKeysCommand request 755 permission on all path to the script used to achieve the functionality. Wrong permissions cause this error in `/var/log/secure`
```
